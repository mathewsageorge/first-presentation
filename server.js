...
mongoose.connect('mongodb+srv://mathewsgeorge202:ansu@cluster0.ylyaonw.mongodb.net/hai?retryWrites=true&w=majority', {
...
const attendanceSchema = new mongoose.Schema({
    ...
    logData: String,
    time: Date
}, { collection: 'mathews' }); // Specify the collection name with dot notation
